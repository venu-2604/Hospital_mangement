...
const navItems = [
  ...
  { path: '/admin/doctors', label: 'Doctors', icon: <Stethoscope size={20} /> },
  { path: '/admin/nurses', label: 'Nurses', icon: <UserRound size={20} /> },
  { path: '/admin/activity', label: 'Activity Log', icon: <ClipboardList size={20} /> },
